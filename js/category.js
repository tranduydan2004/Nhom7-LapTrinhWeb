...
$(document).ready(function() {
    ...
    $("#sortSelect").change(function() {
        ...
        var categoryName = $("#categoryName").text().trim(); // Lấy tên danh mục từ phần tử với id 'categoryName'
        ...
        window.location.href = 'category.php?sort=' + sortOption + '&name=' + encodeURIComponent(categoryName);
    });
